...
class StatusCodeTest(absltest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual(repr(status.StatusCode.NOT_FOUND), "<StatusCode.NOT_FOUND: 5>")
...
class StatusTest(parameterized.TestCase):
    ...
    def test_payload_management_apis(self):
        ...
        self.assertEqual(
            st.AllPayloads(), ((b"Url0", b"Payload0"), (b"Url1", b"Payload1"))
        )
        st.SetPayload("Url2", "Payload2")
        self.assertEqual(
            st.AllPayloads(),
            ((b"Url0", b"Payload0"), (b"Url1", b"Payload1"), (b"Url2", b"Payload2")),
        )
        st.SetPayload("Url2", "Payload2B")
        self.assertEqual(
            st.AllPayloads(),
            ((b"Url0", b"Payload0"), (b"Url1", b"Payload1"), (b"Url2", b"Payload2B")),
        )
        self.assertTrue(st.ErasePayload("Url1"))
        self.assertEqual(
            st.AllPayloads(), ((b"Url0", b"Payload0"), (b"Url2", b"Payload2B"))
        )
